						...
						<li data-id="<?php p($entry['id']); ?>" class="hidden" tabindex="-1">
							<a href="<?php print_unescaped($entry['href']); ?>"
								...
								aria-label="<?php p($entry['name']); ?>">
									<svg width="24" height="20" viewBox="0 0 24 20" alt=""<?php if ($entry['unread'] !== 0) { p(' class="has-unread"'); } ?>>
										<defs>
										...
										<image x="2" y="0" width="20" height="20" preserveAspectRatio="xMinYMin meet"<?php if ($_['themingInvertMenu']) { ?> filter="url(#invertMenuMain-<?php p($entry['id']); ?>)"<?php } ?> xlink:href="<?php print_unescaped($entry['icon'] . '?v=' . $_['versionHash']); ?>" mask="<?php if ($entry['unread'] !== 0) { p('url(#hole)'); } ?>" class="app-icon"></image>
							...
							<ul>
								<?php foreach ($_['navigation'] as $entry): ?>
									...
									<a href="<?php print_unescaped($entry['href']); ?>"
										<?php if ($entry['active']): ?> class="active"<?php endif; ?>
										aria-label="<?php p($entry['name']); ?>">
										<svg width="20" height="20" viewBox="0 0 20 20" alt=""<?php if ($entry['unread'] !== 0) { p(' class="has-unread"'); }?>>
											<defs>
											...
											<image x="0" y="0" width="16" height="16" preserveAspectRatio="xMinYMin meet" filter="url(#invertMenuMore-<?php p($entry['id']); ?>)" xlink:href="<?php print_unescaped($entry['icon'] . '?v=' . $_['versionHash']); ?>" mask="<?php if ($entry['unread'] !== 0) { p('url(#hole)'); } ?>" class="app-icon"></image>
